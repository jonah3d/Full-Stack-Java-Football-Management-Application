...
public class EditarJugadores extends JPanel {
    ...
    private void init_Components() {
        ...
        editplayer = new JButton("Editar");
        editplayer.setIcon(new FlatSVGIcon(ManagemetConstants.sideicon_path + "icon_editjug.svg", 0.7f));
    ...
    private void setupcomponents() {
        ...
        editplayer.setBounds(350, 530, 160, 40);
    ...
    public void editPlayer_OnClick(ActionListener listener) {
        this.editplayer.addActionListener(listener);
    }
